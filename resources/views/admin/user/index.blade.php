    ...
    <div class="card" >
        <div class="card-header d-flex flex-wrap justify-content-center justify-content-xl-between">
            ...
            <div>
                ...
                <a href="{{ route('userPdf') }}" class="btn btn-sm btn-danger" target="__blank"><i class="fas fa-file-pdf mr-2"></i>PDF</a>
            </div>
        </div>
        <div class="card-body">
                    ...
                    <tbody>
                       @foreach ($user as $item)
                        <tr>
                            ...
                            <td>{{ $item->nama }}</td>
                            <td class="text-center"><span class="badge badge-primary">{{ $item->npm }}</span></td>
                            ...
                            <td class="text-center">
                                <a href="{{ route('userEdit', $item->id) }}" class="btn btn-sm btn-warning"><i class="fas fa-edit"></i></a>
